...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `HumidityIcon`.
    static let humidityIcon = Rswift.ImageResource(bundle: R.hostingBundle, name: "HumidityIcon")
    /// Image `Pin`.
    static let pin = Rswift.ImageResource(bundle: R.hostingBundle, name: "Pin")
    /// Image `WindSpeedIcon`.
    static let windSpeedIcon = Rswift.ImageResource(bundle: R.hostingBundle, name: "WindSpeedIcon")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "HumidityIcon", bundle: ..., traitCollection: ...)`
    static func humidityIcon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.humidityIcon, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "WindSpeedIcon", bundle: ..., traitCollection: ...)`
    static func windSpeedIcon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.windSpeedIcon, compatibleWith: traitCollection)
    }
    #endif
